        ...
        <div class="sidebar-body">
            ...
            <div class="sidebar-info-card">
                ...
                <div class="sidebar-info-row">
                    ...
                    Ground Floor, AR Building, Brgy. Upper Calarian
                    (Fronting Yakan Village), Zamboanga City, Philippines
                    </a>
                </div>
            </div>
        </div>
    ...
    if (authSwitch && loginForm && signupForm) {
        ...
        loginForm.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                if (res.ok) {
                    localStorage.setItem('asobiAdminToken', result.token);
                    localStorage.setItem('asobiAdminRole',  result.role);
        ...
        signupForm.addEventListener('submit', async function (e) {
            e.preventDefault();
            var username = signupForm.querySelector('input[name=name]').value;
            ...
            try {
                ...
                if (res.ok) {
                    alert('✅ Account request submitted! Please wait for admin approval before logging in.');
                    signupForm.reset();
                    showLogin();
                } else {
